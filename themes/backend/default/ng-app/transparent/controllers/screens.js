angular.module('viettel1').config(function ($stateProvider, $urlRouterProvider, CFG) {
    ...
    $stateProvider
        .state('list', {
            templateUrl: '/modules/viettel1/themes/backend/default/ng-app/transparent/partials/list.html',
            controller: 'ScreenListController',
            controllerAs: 'vm',
            url: "/list"
        })
        .state('create', {
            templateUrl: '/modules/viettel1/themes/backend/default/ng-app/transparent/partials/form.html',
            controller: 'ScreenFormController',
            controllerAs: 'vm',
            url: "/create",
            params: {
                action: 'create'
        ...
        .state('edit', {
            templateUrl: '/modules/viettel1/themes/backend/default/ng-app/transparent/partials/edit.html',
